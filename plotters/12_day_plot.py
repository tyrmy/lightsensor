...
def print_12_days():
    ...
    for i in range(1,len(input_date)+1):
        ...
        ax.text(0.5, 0.01, len(datetime_objects), verticalalignment='bottom', horizontalalignment='center', transform=ax.transAxes, color='black', fontsize=10)
    ...
    if (config.picture):
        plt.savefig('{}_{}-day_summary.png'.format(datetime.datetime.today(),span), dpi=100, frameon=True)
